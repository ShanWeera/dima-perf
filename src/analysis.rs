...
/// Analyze k-mer diversity with columnar metadata storage
/// 
/// Uses whitelist-based character validation to ensure only valid biological 
/// sequences are processed. Columnar metadata storage provides improved cache 
...
/// 
/// # Returns
/// Tuple of (Results, Option<ValidationStats>)
...
/// Analyze k-mer diversity with row-based metadata storage
/// 
/// Uses whitelist-based character validation to ensure only valid biological 
